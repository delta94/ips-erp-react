          ...
          <Row gutter={[0, 16]}>
            ...
            <Col span={24}>
              <InputNumber
                ...
                onChange={value => updateObjectState("rfq", "shipping_fee", value)}
          ...
          <Row gutter={[0, 16]}>
            ...
            <Col span={24}>
              <InputNumber
                ...
                onChange={value => updateObjectState("rfq", "discount_rate", value)}
...
export default connect(mapStateToProps, { updateObjectState })(RFQOption);

...
import { Divider, Row, Col, Select, Input, InputNumber, DatePicker } from "antd";
      ...
      <Row gutter={16}>
        <Col span={4}>
          <Select
            defaultValue="客户代码"
            value={rfq.customer}
            onChange={value => updateCustomer(value)}
...
export default connect(mapStateToProps, { GetCustomers, updateObjectState, GetCurrency, updateCustomer })(RFQHeader);
